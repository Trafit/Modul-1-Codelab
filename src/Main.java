...
public class Main {
    ...
    public static void main(String[] args) {
        Main main = new Main();
        Admin.StudentList[Admin.studentCount] = new Student("Tengku Kun", "Fakultas Teknik", "202310370311427", "Informatika");;
        Admin.studentCount++;
        Admin.StudentList[Admin.studentCount] = new Student("Zero Chan", "Fakultas Hukum", "202010330211002", "Hukuman");;
        Admin.studentCount++;
        Admin.StudentList[Admin.studentCount] = new Student("Katarinablu", "Fakultas Kedokteran", "202110370321404", "Kedokteran Jiwa");;
        Admin.studentCount++;

        User.bookList[Admin.bookCount] = new HistoryBook("388c-e681-9152", "Kimi no namae", "Makoto", 4);
        Admin.bookCount++;
        User.bookList[Admin.bookCount] = new StoryBook("ed90-be30-5cdb", "Siksa Neraka", "Abah ", 1);
        Admin.bookCount++;
        User.bookList[Admin.bookCount] = new TextBook("d95e-0c4a-9523", "Go jo", "Setengah", 1);
        Admin.bookCount++;
        while (!exit) {
            main.menu();
        }
